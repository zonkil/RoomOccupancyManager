...
class DefaultRoomOccupancyServiceIntegrationTest extends Specification {
    ...
    def "shouldCalculateRoomOccupancy"() {
        ...
        2          | 2          | [150.0, 150.0, 5.0, 5.0]                                            | 2       | 300.0     | 2      | 10.0
        3          | 1          | [150.0, 150.0, 5.0, 5.0]                                            | 3       | 305.0     | 1      | 5.0
        4          | 4          | [150.0, 150.0, 5.0, 5.0]                                            | 2       | 300.0     | 2      | 10.0
        1          | 1          | [150.0, 150.0, 5.0, 5.0]                                            | 1       | 150.0     | 1      | 5.0
    }
}
